...
import { useCreatePersonalGoal } from '@/hooks/useGoals';
...
export function AddGoalModal({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  const [color, setColor] = useState('#1e3a2f');
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Thêm Mục Tiêu" maxWidth="md">
